...
def run_startup_checks(settings: Settings) -> None:
    # AUTH_KEY is required by Rust; enforce parity here.
    ...
    # LITE_LLM_ADDRESS sanity note (do not fail Phase-1 if not reachable)
    ...
    # Future: optional ping to LiteLLM for liveliness (warning only)
    logger.info(
